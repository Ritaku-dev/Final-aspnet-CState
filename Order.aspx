<%@ Page Language="C#" Trace="false" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="EcommerceFinal.Order" %>
<!DOCTYPE html>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT [ProductID], [Name], [ShortDescription], [LongDescription], [CategoryID], [UnitPrice], [OnHand], [ImageFile] FROM [Products]" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>">
                            </asp:SqlDataSource>
                        </div>
                    </div>   
                    <div class="form-group">

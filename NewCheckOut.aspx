<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCheckOut.aspx.cs" Inherits="EcommerceFinalCart.CheckOut" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>EcommerceFinal: Shopping Cart</title>
        ...
        <form id="form1" runat="server" class="form-horizontal" 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <asp:RequiredFieldValidator ID="rfvPhoneNumber" runat="server" 
                        ...
                        Display="Dynamic" InitialValue="###-###-####" ControlToValidate="txtPhone">Required</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="revPhoneNumber" runat="server" 
                        ErrorMessage="Phone number" CssClass="text-danger"
                        Display="Dynamic" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}"
                        ControlToValidate="txtPhone">Use this format: 999-999-9999
                ...
                <div class="col-sm-5">
                    <asp:TextBox ID="txtDOB" runat="server" CssClass="form-control" Height="30px" Width="146px"></asp:TextBox>
                    </div>
                    <div
                        class="col-sm-4">
                        <asp:RegularExpressionValidator ID="RegValDOB" runat="server" 
                        ErrorMessage="Enter Date of Birth" CssClass="text-danger"
                        Display="Dynamic" ValidationExpression="[01]?\d\/[0-3]\d\/\d{4}"
                        ControlToValidate="txtDOB">Use this format: mm/dd/yyyy
                    </asp:RegularExpressionValidator>
                        </div>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [Email], [LastName], [FirstName], [Address], [City], [State], [ZipCode], [PhoneNumber] FROM [Customers]" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>">
                    </asp:SqlDataSource>
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <asp:RegularExpressionValidator ID="rfvZipVal" runat="server"
                        ErrorMessage="Enter Zip Code"
                        ValidationExpression="\d{5}(-\d{4})?"
                        ControlToValidate="txtZip">Use this format: 99999 or 99999-9999
                    </asp:RegularExpressionValidator>
                </div>
            </div>  
